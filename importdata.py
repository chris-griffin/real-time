...
for stop in STOP_IDS:
	...
	for time in times[:NUM_TRAINS]:
		out+=str(time)
		temp_num_trains = NUM_TRAINS
		if temp_num_trains > 1:
			out+=str(',')
			temp_num_trains = temp_num_trains - 1
	...
	draw.text((14, 1), out,(75,75,75),font=font)
	staticimg.save('dynamicimages/dynamictime.ppm')
	times = []
	out = ''

	os.system('sudo ./rpi-rgb-led-matrix/led-matrix -r 16 -c 2 -t 5 -j -D 1 -m 5000 rpi-rgb-led-matrix/dynamictime.ppm')
